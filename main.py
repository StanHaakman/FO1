...
print(palindroom(palindroom_test))
...
new_file = open("compressie.txt", "w")
...
def fibonacci(number, last=0, second_to_last=1):
    if number > 1:
        return fibonacci(number - 1, second_to_last, last + second_to_last)
    return (last, second_to_last)[number]
